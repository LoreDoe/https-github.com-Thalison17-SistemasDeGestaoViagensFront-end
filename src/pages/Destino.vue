<template>
    <q-page class="destino-page q-pa-md">
      <div v-if="destino" class="q-mb-lg">
        ...
        <div class="q-mb-md">
          <p class="text-body1">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eget ligula a erat fermentum auctor. Ut sit amet ligula in lorem tincidunt malesuada. Donec aliquet ipsum vel urna laoreet, et dictum nunc iaculis. Vivamus a volutpat metus, nec feugiat felis. Morbi sit amet tristique lorem, non tincidunt nunc. Cras vitae est sit amet urna tempus placerat. Curabitur fringilla massa magna, ut rutrum nunc tempor sit amet.
          </p>
        </div>
  ...
  export default {
    setup() {
      ...
      // Dados de exemplo, similar ao que você tem em "destinopage.vue"
      const destinos = [
